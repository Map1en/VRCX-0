...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::app::vrchat_api::app__vrchat_auth_execute,
            api::app::vrchat_api::app__vrchat_friend_execute,
            api::app::vrchat_api::app__vrchat_favorite_execute,
            api::app::vrchat_api::app__vrchat_search_execute,
            api::app::vrchat_api::app__vrchat_avatar_execute,
            api::app::vrchat_api::app__vrchat_world_execute,
            api::app::vrchat_api::app__vrchat_group_execute,
            api::app::vrchat_api::app__vrchat_instance_execute,
            api::app::vrchat_api::app__vrchat_notification_execute,
            api::app::vrchat_api::app__vrchat_media_execute,
            api::app::vrchat_api::app__vrchat_tools_execute,
            api::app::vrchat_api::app__external_avatar_search_execute,
            api::app::vrchat_api::app__external_translation_execute,
            api::app::vrchat_api::app__external_youtube_execute,
            api::app::vrchat_api::app__external_vrc_status_execute,
            api::app::vrchat_api::app__external_update_release_execute,
            api::app::vrchat_api::app__external_image_execute,
