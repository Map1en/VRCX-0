...
pub fn app__instance_activity_dates_get(
    ...
    vrcx_0_store::player_list::app__instance_activity_dates_get(state.db.as_ref(), user_id)
...
pub fn app__instance_activity_rows_get(
    ...
    vrcx_0_store::player_list::app__instance_activity_rows_get(
        state.db.as_ref(),
        start_date,
        end_date,
    )
...
pub fn app__player_list_join_leave_rows(
    ...
    vrcx_0_store::player_list::app__player_list_join_leave_rows(
        state.db.as_ref(),
        location,
        started_at,
    )
...
pub fn app__player_list_latest_location_get(
    ...
    vrcx_0_store::player_list::app__player_list_latest_location_get(state.db.as_ref())
        .map_err(AppError::from)
}
...
pub fn app__player_list_location_get(
    ...
    vrcx_0_store::player_list::app__player_list_location_get(state.db.as_ref(), location)
        .map_err(AppError::from)
}
...
pub fn app__world_summaries_get(
    ...
    vrcx_0_store::player_list::app__world_summaries_get(state.db.as_ref(), world_ids)
        .map_err(AppError::from)
}
