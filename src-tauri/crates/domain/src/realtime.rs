...
impl RealtimeMessageParser {
    pub fn parse_text(&mut self, raw: &str, received_at: impl Into<String>) -> Option<RealtimeWsMessagePayload> {
...
mod tests {
    ...
    fn ignores_invalid_json() {
        ...
        assert!(parser.parse_text("not-json", "2026-05-14T00:00:00Z").is_none());
    }
