...
export function firstFiniteLocationNumber(...values) {
...
export function resolveLocationTarget(location, traveling) {
...
export function normalizeLocationObject(locationObject) {
...
export function locationObjectWorldName(locObj) {
...
export function locationObjectGroupName(locObj) {
    return normalizeLocationText(
        locObj?.groupName ||
            locObj?.group?.name ||
...
export function worldDialogTarget(locObj) {
    return (
...
export function launchTagForLocationObject(locObj) {
...
export function isUsableInstanceLocation(parsedLocation) {
    return Boolean(
