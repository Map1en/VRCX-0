...
function withEndpoint(queryKey: unknown[], endpoint = ''): QueryKey {
...
export const queryKeys = Object.freeze({
    ...
    worldsByUser: (params: EntityQueryParams = {}, endpoint = '') =>
        withEndpoint(
            ['worlds', 'user', params.userId, stableParams(params)],
            endpoint
        ),
    groupMembers: (params: EntityQueryParams = {}, endpoint = '') =>
        withEndpoint(
            ['group', params.groupId, 'members', stableParams(params)],
            endpoint
        ),
    groupGallery: (params: EntityQueryParams = {}, endpoint = '') =>
        withEndpoint(
            [
                'group',
                params.groupId,
    ...
    userDialogTabCounts: (params: EntityQueryParams = {}, endpoint = '') =>
        withEndpoint(
