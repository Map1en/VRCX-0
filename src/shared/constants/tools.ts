...
const toolDefinitions: ToolDefinition[] = [
    ...
    },
    {
        ...
        category: 'social',
        iconKey: 'message',
        navIcon: 'PresenceInviteRequests',
