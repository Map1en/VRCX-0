...
function openWorldLocation(location: unknown, title = '') {
...
export function buildVrcLaunchUrl(location: unknown, shortName = '') {
...
async function verifyShortName(location: unknown, shortName: string, endpoint = '') {
...
async function openGroupByShortCode(shortCode: string, endpoint = '') {
...
async function directAccessWorld(rawInput: unknown, endpoint = '') {
...
export async function directAccessParse(input: unknown, endpoint = '') {
