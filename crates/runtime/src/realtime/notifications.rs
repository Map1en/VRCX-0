...
use vrcx_0_store::realtime::{NotificationExpiration, NotificationV2Update};
...
pub fn apply_instance_closed_ws_message(
    ...
    Some(RealtimeInstanceClosedOutput {
        ...
        persistence: vrcx_0_store::realtime::RealtimePersistenceBatch {
            notification_v1_upserts: vec![notification],
            ..vrcx_0_store::realtime::RealtimePersistenceBatch::default()
        },
    })
}
